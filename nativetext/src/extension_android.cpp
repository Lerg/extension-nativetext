...
int EXTENSION_GENERATE_TEXT_BITMAP(const char *text, int font_size, const char *font_name,
	...
	if (java_extension_object != NULL) {
		...
		result = env->CallIntMethod(java_extension_object, java_extension_generate_text_bitmap,
			...
			(jint)text_width, (jint)text_align, (jboolean)underline, (jfloat)spacing_mult, (jfloat)spacing_add, (jfloat)outline_size, (jfloat)shadow_size, (jfloat)shadow_x, (jfloat)shadow_y,
...
void EXTENSION_INITIALIZE(lua_State *L) {
	...
	java_extension_generate_text_bitmap = env->GetMethodID(java_extension_class, "generate_text_bitmap", "(Ljava/lang/String;ILjava/lang/String;IIZFFFFFFFFFFFFFFFFFFFFFF)I");
